    ...
    try:
        ...
        if text:
            ...
            if contentTags != "":
                ...
                responseAI = generalAI.get(text, 'Extraia exatamente 8 tags, nenhuma mais e nenhuma menos, que representando o conteúdo do texto acima. As tags devem: ter no máximo 25 caracteres, conter apenas letras e espaço (sem números ou símbolos), e estar separadas por vírgula. De prioridade para palavras que mais se repetem e que estejam em destaque.')
                print(responseAI)
